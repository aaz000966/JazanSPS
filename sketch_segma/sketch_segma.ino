...
IPAddress server_addr(54,247,107,148);  // IP of the MySQL *server* here 54.247.107.148   eHost : 108.167.160.65  108.167.160.65
char user[] = "sql2105932";              // MySQL user login username    sql2105329         jazanusp_aaz
char password[] = "nY9%tF2!";        // MySQL user login password  iH1%tA7*          17654321aaZ   
