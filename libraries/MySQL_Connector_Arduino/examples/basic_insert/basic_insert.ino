...
IPAddress server_addr(54,247,107,148);  // IP of the MySQL *server* here 54.247.107.148
char user[] = "sql2105329";              // MySQL user login username
char password[] = "iH1%tA7*";        // MySQL user login password

// Sample query
char INSERT_SQL[] = "Update sql2105329.hello_arduino set availability = 1 where ID = 1;";
